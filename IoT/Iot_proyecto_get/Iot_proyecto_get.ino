...
// WiFi
const char *ssid = "INGRESE SSID"; // Enter your WiFi name
const char *password = "INGRESO PASSWORD";  // Enter WiFi password

//Your Domain name with URL path or IP address with path
const char* serverName = "http://192.168.0.8:1880/update-sensor"; //repleace  192.168.0.101 for your addres
const char* serverNameGet = "http://192.168.0.8:1880/get-sensor"; //repleace  192.168.0.101 for your addres
...
void RPM( void *pvParameters ) {
  while (1) {
    ...
    temperatura1 = String(counter);
    temperatura2 = String(counter);
    counter = 0;
  }
}
